    ...
    if choices == "Program":
        ...
        if st.button("Predict Now"):
            try:
                ...
                st.write("Predicted Class:", classIndex)
                st.write("Max Probability:", probabilityValue)
        ...
        st.write(
            "Application Developed by Yashmeet Baid for CIE3 component of the IML course.")
